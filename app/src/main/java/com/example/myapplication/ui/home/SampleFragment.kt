...
class SampleFragment : Fragment() {
    override fun onCreateView(
        ...
        val myGridGalleryItems = listOf(
            ...
            HomeFragment.GalleryItem(R.drawable.art_5, "Grid Title 1"),
            HomeFragment.GalleryItem(R.drawable.art_4, "Grid Title 2"),
            HomeFragment.GalleryItem(R.drawable.art_3, "Grid Title 3"),
            HomeFragment.GalleryItem(R.drawable.art_6, "Grid Title 4"),
